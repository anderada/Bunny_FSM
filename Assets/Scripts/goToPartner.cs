...
namespace NodeCanvas.Tasks.Actions {
	...
	public class goToPartner : ActionTask {

        public BBParameter<Transform> partnerLocation;
        ...
        {
            lonelySign.gameObject.SetActive(true);
        }

        //Called once per frame while the action is active.
        protected override void OnUpdate()
        {
            target = partnerLocation.value.position;
        ...
        protected override void OnStop()
        {
            ...
            agent.GetComponent<Rabbit>().socializing = false;
        }
